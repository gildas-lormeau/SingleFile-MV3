(function () {
	...
	init$3({ isSavingTab, saveTabs, saveUrls, cancelTab, openEditor, saveSelectedLinks, batchSaveUrls });
	...
	browser.tabs.onReplaced.addListener((addedTabId, removedTabId) => onTabReplaced$2(addedTabId, removedTabId));
